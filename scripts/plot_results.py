...
def main() -> None:
    ...
    fig.text(0.015, 0.005,
             "Qwen2.5 on Kaggle T4s  ·  accuracy on 200 held-out xLAM tool calls  ·  gold = SFT on "
             "labels, distil = teacher's outputs, logit = teacher's distribution",
